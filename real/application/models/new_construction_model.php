...
class New_construction_model extends CI_Model {

	var $cords = '27.944824708220683 -82.55502604879445,27.944976353651015 -82.4594106618315,27.9040243580111 -82.4377813283354,27.811597947718482 -82.47640513814986,27.840138645832145 -82.55468272604048,27.944824708220683 -82.55502604879445';
	
	/**
	 * get the records for new constructions
	 *
	 * @access	public
	...
	function get_total_count(){
		...
		$this->db->where("`3084`",'Yes'); //new construction
	...
	/**
	 * get the records for new construction
	 *
	 * @access	public
	 * @return	number of the search results
	 */
	function get_data($get_count = 0,$limit=18,$offset=0){
