...
<title><?= WEBSITE_NAME2 ?> - Exclusive Properties</title>
		...
		<div id="tab4" class="tabContents" style="min-height:1415px;">
		  ...
		  <?php
			...
			?>
			  ...
			  <td><div class="searchResult"> <a class="propPhotoWrapper" title="View Full Property Details For <?php echo $address; ?>" href="<?php echo "http://" . $_SERVER['HTTP_HOST'].'/real-estate/property-details/'.$property_details["175"]; ?>">
				  ...
				  <div class="propDetails">
					...
					<h3> <a title="View Full Property Details For  <?php echo $address; ?>" href="<?php echo "http://" . $_SERVER['HTTP_HOST'].'/real-estate/property-details/'.$property_details["175"]; ?>">
