...
<base target="_parent" />
<title>Strickland Group &raquo; Property Search</title>
...
<div class="ad_container">
    <div id="fl_menu" class="formCounter">
      <span class="formCounterCountValue">
	  	<?php  
			if(!empty($total_count) && ($total_count >= 9999) ){
				echo '9000+'; 
			}else{
      ...
      <span class="formCounterSubmit"><input type="button" onClick="$('#fl_menu').hide();$('#AdvancedSearchForm').submit();" class="btn-search customWhiteButton" value=""></span>
    </div>    
    <div id="contentSidebar">
        <div id="subNavWrapper">
          <a title="Search" id="subNavPageName"  style="cursor:default;" href="javascript:;">Search</a>
          <ul>
            <li> <a title="Property Search" class="sub_active_link" href="<?php echo WEBSITE_URL; ?>search-all-properties/">Property Search</a> </li>
            <li> <a title="Map Search" href="<?php echo WEBSITE_URL; ?>map-search/">Map Search</a> </li>
          </ul>
          <br><br>
          <a id="subNavPageName" style="cursor:default;" href="javascript:;">Related Topics</a>
          <ul>
            <li> <a title="Buying" href="<?php echo WEBSITE_URL; ?>buying/">Buying</a> </li>
            <li> <a title="Our Listings" href="<?php echo WEBSITE_URL; ?>our-listings/">Our Listings</a> </li>
            <li> <a title="Feature Communities" href="<?php echo WEBSITE_URL; ?>featured-communities/">Feature Communities</a> </li>
            <li> <a title="Connect with Us" href="<?php echo WEBSITE_URL; ?>connect-with-us/">Connect with Us</a> </li>
          </ul>


          <br>          
<div id="leftsidebarAccount" class="i_sideBar_search">
  <p> Be the First to<br>
    Know   <a title="Create an account" style="padding-left:10px" href="#"><img alt="Create an account" src="img/i_arrow.png"></a></p>
  <ul>
  ...
  <div class="createAndSignUpButtons">
  <?php if(empty($logged_in)){ ?>
  	<a href="<?php echo $base.'account/login'; ?>" style="background-color: #0A57A3;color: #FFFFFF;padding:10px;font-weight:bold">Login</a>
    <a href="<?php echo $base.'account/signup'; ?>" style="background-color: #0A57A3;color: #FFFFFF;padding:10px;font-weight:bold">Create an Account</a>
  <?php }else{ ?>
    <a href="<?php echo $base.'account/home'; ?>" style="background-color:#0A57A3;padding:10px;color:#fff;font-weight:bold">Dashboard</a>
  	<a href="<?php echo $base.'account/logout'; ?>" style="background-color:#0A57A3;padding:10px;color:#fff;font-weight:bold">Logout</a>
  <?php } ?>
  </div>
        ...
        <div class="advancedSearch">
          ...
          <form method="post" name="simple_search" id="SimpleSearchForm" action="<?php echo $base?>search/simple_search">
            <div class="addressAndLocWrapper clearfix">
              ...
              <input type="text" value="" class="addressAndLoc" name="location" id="as_street_name">
			  <input type="submit" id="search" class="CustonBlueButton" value="Search">
            </div>
          </form>
          <div class="orSeperator clearfix"> <span><strong>OR</strong></span> </div>
            <div class="main-property-type-list clearfix">
              <ul class="clearfix propertyList">
                ...
                <li> <span class="controls">
                  <label class="radio">
                  <input type="radio" name="Property_Type" value="93" data-template="land" data-action="change-property-type" onClick="propertyType('Vacant');">
                          ...
                          <div class="formContainer" id="residentialSearchFormWrapper">
                            ...
                            <div class="section">
                              ...
                              <div class="location-list clearfix">
                                <ul class="clearfix">
                                  ...
                                  <li> <span class="controls">
                                    <label class="radio white">
                                    <input type="radio" name="location-select" data-target="zipField" value="rad-zip" onClick="locationType('zip_code');" />
                                    Zip Code </label>
                                    </span> </li>
                                  <li> <span class="controls">
                                    <label class="radio white">
                              ...
                              <div id="locationFields">
                                ...
                                <div style="display:none;" id="zip_code" class="field clearfix">
                                ...
                                <div id="countyField" class="field msw_container">
                                  ...
                                  <select id="countyOptions" class="selectField selectField-full" name="county_id[]" multiple="multiple">
                            ...
                            <div class="section noborder clearfix">
	                          ...
	                          <div class="field fieldRight">
                                ...
                                <select name="waterfront" class="selectField selectField-half" title="Select Water Access Preference">
                            ...
                            <div id="exterior" class="expand-section">
                              ...
                              <div class="expand-block">
                                <div class="section noborder">
                                  ...
                                  <div class="clearAll">&nbsp;</div>
                                  <?php /*?><div class="field fieldLeft msw_container">
...
<input type="hidden" id="wordpress_search" value="<?=$wordpress_search?>" />
<input type="hidden" id="wordpress_location_city" value= "<?=$wordpress_location_city?>"/>
<input type="hidden" id="wordpress_price_min" value= "<?=$wordpress_price_min?>"/>
<input type="hidden" id="wordpress_price_max" value= "<?=$wordpress_price_max?>"/>
<input type="hidden" id="wordpress_num_beds" value= "<?=$wordpress_num_beds?>"/>
<input type="hidden" id="wordpress_num_fbaths" value= "<?=$wordpress_num_fbaths?>"/>
<input type="hidden" id="wordpress_sqft_liv_area" value= "<?=$wordpress_sqft_liv_area?>"/>
...
// alert("coming");    
    ...
    $("#SimpleSearchForm").submit(function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?=$base?>search/simple_search/'+offset,
    ...
    $("#AdvancedSearchForm").submit(function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?=$base?>search/advance_search/'+offset,
     ...
     var wordpress_search=  $('#wordpress_search').val();
	 	 
	if(wordpress_search == 1){
		 
		var wp_location_city = $('#wordpress_location_city').val();
		var wp_wordpress_price_min = $('#wordpress_price_min').val();
		
		var wp_wordpress_price_max = $('#wordpress_price_max').val();
		var wp_wordpress_num_beds = $('#wordpress_num_beds').val();
		var wp_wordpress_num_fbaths = $('#wordpress_num_fbaths').val();
 		var wordpress_sqft_liv_area = $('#wordpress_sqft_liv_area').val();
		
		if(wp_location_city){
			$('#as_city').val(wp_location_city);
		}
		if(wp_wordpress_price_min){
			$('#as_minPrice').val(wp_wordpress_price_min);
		}
		if(wp_wordpress_price_max){
			$('#MaxPriceSelect').val(wp_wordpress_price_max);
		}
		if(wp_wordpress_num_beds){
			$('#as_minBeds').val(wp_wordpress_num_beds);
		}
		if(wp_wordpress_num_fbaths){
			$('#as_fullBaths').val(wp_wordpress_num_fbaths);
		}
		if(wordpress_sqft_liv_area){
			$('#as_minSqftTotal').val(wordpress_sqft_liv_area);
		}
  ...
  function get_count(){
    $.ajax({
      ...
      success: function(result) {
        ...
        {
		   if(result.total_count >= 9999){
           		$(".formCounterCountValue").html('9000+');
		   }else{
  ...
  function show_advanced_form(){
  	var wordpress_search=  $('#wordpress_search').val();
	if(wordpress_search == 1){
		$('#wordpress_search').val('0');
		window.top.location.href = "<?php echo WEBSITE_URL; ?>search-all-properties/";
		return false;
	}
    $("#search_offset").val(0);
