...
tab1 += '<div class="row-fluid">'+
	...
	tab1 += '<a target="_blank" onclick="recently_viewed('+res["sysid"]+');" href="http://www.candacecourter.com/property-details/?mls='+res[175]+'" style="color:blue;">View Property Details</a>';
	tab1 += '</div>' +
'</div>';
var tab3 = res[3187];
