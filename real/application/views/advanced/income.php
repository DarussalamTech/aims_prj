  ...
  <div class="formContainer" id="residentialSearchFormWrapper">
    ...
    <div class="section">
      ...
      <div class="field fieldLeft">
        ...
        <select name="pro_style[]" title="Select Property Type" multiple="multiple" class="selectField selectField-half  selectField-multiple" id="as_Type">
      ...
      <?php /*?><div class="field fieldRight" style="padding-left:65px">

        <label for="as_totalUnitsMin" class="block bold">Total Units</label>

        <select name="ComplexUnits" title="Select Minimum Total Units" class="selectField selectField-fourth" id="as_totalUnitsMin">
        ...
        <select name="ComplexUnitsMax" title="Select MaximumTotal Units" class="selectField selectField-fourth">
      ...
      <div class="field fieldLeft">
        ...
        <label for="as_numBuildingsMin" class="block bold">Total Number of Buildings</label>

        <select name="MinBuildings" title="Select Minimum Number of Buildings" class="selectField selectField-fourth" id="as_numBuildingsMin">
        ...
        <select name="MaxBuildings" title="Select Maximum Number of Buildings" class="selectField selectField-fourth">
      ...
      <div class="field fieldLeft">
        ...
        <label for="MinPriceSelect" class="block bold">Price Range</label>

        <select name="price_min" title="Select Minimum Price" data-target="asMinPriceAlt" class="selectField selectField-fourth selectCombo" id="MinPriceSelect">
      ...
      <div class="location-list clearfix">
        ...
        <ul class="clearfix">
          ...
          <li> <span class="controls">
            ...
            <input type="radio" checked="checked" name="location-select" data-target="cityField" onclick="locationType('cityField');">
          ...
          <li> <span class="controls">
            ...
            <input type="radio" name="location-select" data-target="zipField" onclick="locationType('zipField');">
          ...
          <li> <span class="controls">
            ...
            <input type="radio" name="location-select" data-target="countyField" onclick="locationType('countyField');">
    ...
    <div id="additionalDetails" class="expand-section">
      ...
      <div class="expand-trigger" onclick="expandBlock('additionalDetails');"> <span class="expand-icon">&nbsp;</span>
        ...
        <p class="expand-description">Specific criteria including general features such as pets allowed, water views and more...</p>
      ...
      <div class="expand-block">
		...
		<div class="section">
		  ...
		  <div class="field fieldRight">
            ...
            <input type="text" value="" title="Enter Earliest Year Built" name="year_built" id="as_minYear" class="textField textField-half">
		  </div>
		  ...
		  <!--<div class="field fieldLeft">
			...
			<label for="as_subdivision" class="bold block">Subdivision</label>

			<input type="text" value="" title="Enter Comma-Separated List of Subdivision Number Options" name="Subdivision_number[]" id="as_subdivision" data-src="2013_income_subdivision_number" class="textField autoCompleteField validate-entry textField-half ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true">
		  ...
		  <div class="field fieldLeft msw_container">
			...
			<select class="selectField selectField-half selectField-multiple" multiple="multiple" name="community_features[]" title="Select Multiple Community Features">
			  ...
			  <option value="association recreation - owned">Association Recreation - Owned</option>
			  ...
			  <option value="horse stables">Horse Stables</option>

			  <option value="laundry facility">Laundry Facility</option>

			  <option value="maintenance free">Maintenance Free</option>

			  <option value="no truck/rv/motorcycle parking">No Truck/rv/motorcycle Parking</option>
			  ...
			  <option value="private boat ramp">Private Boat Ramp</option>

			  <option value="public boat ramp">Public Boat Ramp</option>

			  <option value="pud">Pud</option>

			  <option value="racquet ball">Racquet Ball</option>
		  ...
		  <div class="field fieldLeft">
			...
			<label for="as_communityName" class="bold block">Complex / Community Name / NCCB</label>

			<input type="text" value="" title="Enter Comma-separated list of Community Names" name="Complex_Community_Name" id="as_communityName" data-src="2013_income_complex_comm_name" class="textField textField-half autoCompleteField validate-entry ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true">
        ...
        <div class="field fieldRight">
			...
			<input type="text" value="" title="Enter Minimum Heated Square Feet" name="Min_SqftTotal" id="as_heatedSqft" data-src="2013_income_sqft" class="textField textField-half ">
		  ...
		  <div class="field fieldRight msw_container income">
			...
			<select class="selectField selectField-half selectField-multiple" multiple="multiple" name="LeaseTermsDesc[]" title="Select Multiple Lease Terms Options">
			  ...
			  <option value="limited pets">Limited Pets</option>

			  <option value="month to month">Month To Month</option>

			  <option value="pet deposit">Pet Deposit</option>

			  <option value="renewal option">Renewal Option</option>

			  <option value="tenant pays electri">Tenant Pays Electri</option>

			  <option value="tenant pays electric">Tenant Pays Electric</option>

			  <option value="tenant pays sewer">Tenant Pays Sewer</option>

			  <option value="tenant pays water">Tenant Pays Water</option>
        ...
        <div class="section noborder">
          ...
          <div class="field fieldLeft radioGroup">
            ...
            <input type="radio" title="Select Water View Preference" name="WaterView" value="Yes">

            <span>Yes</span> </label>

            <label class="checkBoxLabel">

            <input type="radio" title="Select Water View Preference" name="WaterView" value="No">

            <span>No</span> </label>

            <label class="checkBoxLabel last">

            <input type="radio" title="Select Water View Preference" name="WaterView" value="">

            <span>No Preference</span> </label>

          </div>

          <div class="field fieldRight radioGroup">

            <label class="block bold">Water Extras</label>

            <label class="checkBoxLabel">

            <input type="radio" title="Select Water Access Preference" name="WaterExtrasBit" value="Yes">

            <span>Yes</span> </label>

            <label class="checkBoxLabel">

            <input type="radio" title="Select Water Access Preference" name="WaterExtrasBit" value="No">

            <span>No</span> </label>

            <label class="checkBoxLabel last">

            <input type="radio" title="Select Water Access Preference" name="WaterExtrasBit" value="">
      ...
      <div class="expand-block">
        ...
        <div class="section noborder">
          ...
          <div class="field fieldRight msw_container">
            ...
            <select class="selectField selectField-half selectField-multiple" multiple="multiple" name="KitchenFeatures[]" title="Select Multiple Kitchen Features">
              ...
              <option value="cooking island">Cooking Island</option>
          ...
          <div class="field fieldLeft msw_container">
            ...
            <select class="selectField selectField-half selectField-multiple" multiple="multiple" name="Appliances[]" title="Select Multiple Included Appliances">
              ...
              <option value="hot water gas">Hot Water Gas</option>
              ...
              <option value="water softener owned">Water Softener Owned</option>
        ...
        <div class="field fieldRight msw_container">
          ...
          <select class="selectField selectField-half selectField-multiple" multiple="multiple" name="utilitiesIncluded[]" title="Select Multiple Utility Preferences">
            ...
            <option value="private munic system">Private Munic System</option>

            <option value="private municipal wate">Private Municipal Wate</option>
            ...
            <option value="sprinkler meter">Sprinkler Meter</option>

            <option value="sprinkler recycled">Sprinkler Recycled</option>
    ...
    <div class="expand-block">
      ...
      <div class="section noborder">
        ...
        <div class="field fieldLeft">
          ...
          <label for="as_Zip" class="bold block">Pool</label>

          <input type="text" value="" title="Enter Pool Preference" name="PoolDesc" id="as_pool" data-src="2013_residential_pool" class="textField textField-half autoCompleteField validate-entry ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true">
        ...
        <div class="field fieldRight msw_container">
          ...
          <select class="selectField selectField-half selectField-multiple" multiple="multiple" name="ExteriorDesc[]" title="Select Multiple Exterior Features">
            ...
            <option value="open patio">Open Patio</option>
            ...
            <option value="utilit">Utilit</option>
       ...
       <!-- <div class="field fieldLeft msw_container">
        ...
        <div class="field fieldRight msw_container">
          ...
          <select class="selectField selectField-half selectField-multiple" multiple="multiple" name="Construction[]" title="Select Multiple Exterior Construction Options">
        ...
        <div class="field fieldLeft radioGroup">
          ...
          <label class="block bold">Sidewalk</label>

          <label class="checkBoxLabel">

          <input type="radio" title="Select Sidewalk Preference" name="SidewalksBit" value="1">

          <span>Yes</span> </label>

          <label class="checkBoxLabel">

          <input type="radio" title="Select Sidewalk Preference" name="SidewalksBit" value="0">

          <span>No</span> </label>

          <label class="checkBoxLabel last">

          <input type="radio" title="Select Sidewalk Preference" name="SidewalksBit" value="">
