...
<base target="_parent" />
<title>Candace Courter - Property Search</title>
...
<div class="ad_container">
    <div id="fl_menu" class="formCounter">
	    <span class="formCounterCountValue"><?php  echo number_format($total_count, 0, ".", ",");  ?></span>
        <span class="formCounterText">listings</span>
        <span class="formCounterSubmit"><input type="button" onClick="$('#fl_menu').hide();$('#AdvancedSearchForm').submit();" class="btn-search" value=""></span>
    </div>    
    <div id="contentSidebar">
        <div id="subNavWrapper">
          <a title="Search" id="subNavPageName" href="<?php echo "http://" . $_SERVER['HTTP_HOST'] ?>/buy/search-all-properties/">Search</a>
          <ul>
            <li> <a title="Property Search" class="sub_active_link" href="<?php echo "http://" . $_SERVER['HTTP_HOST'] ?>/buy/search-all-properties/">Property Search</a> </li>
            <li> <a title="Map Search" href="<?php echo "http://" . $_SERVER['HTTP_HOST'] ?>/buy/map-search/">Map Search</a> </li>
            <!--<li> <a title="Proximity Search" href="/proximity_search/">Proximity Search</a> </li>
            <li> <a title="Commercial Search" href="/commercial_search/">Commercial Search</a> </li>
            <li> <a title="Developments Search" href="/developments_search/">Developments Search</a> </li>-->
          </ul>
<div id="leftsidebarAccount">
  <p> Be the First to<br>
    Know </p>
  <ul>
    <li> Be the first to know when new listings hit the market on your iPhone, iPad, Android and across all of your devices. </li>
    <li> Create custom searches, and easily manage all of your purchase opportunities. </li>
  </ul>
  <a title="Create an account" class="floatRight" href="http://www.candacecourter.com/real-estate/account/login"><img alt="Create an account" src="http://www.candacecourter.com/wp-content/uploads/2013/12/btn_createAccount.gif"></a>
  <div class="clearAll">&nbsp;</div>
	...
	<div id="contentRightWrapper">
        ...
        <div class="advancedSearch">
          <h1 class="shadowHeader">Advanced Search</h1>
          <form method="post" name="simple_search" id="SimpleSearchForm" action="<?php echo $base?>search/simple_search">
            <div class="addressAndLocWrapper clearfix">
              <label for="as_street_name" class="bold block searchByAddressLabel">Search by Address, Zip Code or MLS#</label>
              <input type="text" value="" class="addressAndLoc" name="AddressAndLoc" id="as_street_name">
              <input type="submit" value="" class="btn-search"  style="width:79px;" >
            </div>
          </form>
          <div class="orSeperator clearfix"> <span><strong>OR</strong></span> </div>
            <div class="main-property-type-list clearfix">
              <ul class="clearfix propertyList">
                <li> <span class="controls">
                  <label class="radio white">
                  <input type="radio" checked="checked" name="Property_Type" data-template="residential" value="91" data-action="change-property-type" onClick="propertyType('Residential');">
                  Residential<img title="Includes single family homes, condominiums, townhomes, villas, and duplexes." class="padding-right-10 justTheTip" src="<?=$base?>bootstrap/img/icon_question.gif" alt=""> </label>
                  </span> </li>
                <li> <span class="controls">
                  <label class="radio">
                  <input type="radio" name="Property_Type" value="94" data-template="rental" data-action="change-property-type" onClick="propertyType('Rental');">
                  Rental<img title="Includes single family homes, condominiums, villas, townhomes, apartments, and duplexes." class="padding-right-10 justTheTip" src="<?=$base?>bootstrap/img/icon_question.gif" alt=""> </label>
                  </span> </li>
                <li> <span class="controls">
                  <label class="radio">
                  <input type="radio" name="Property_Type" value="92" data-template="commercial" data-action="change-property-type" onClick="propertyType('Commercial');">
                  Commercial<img title="Includes office buildings, retail property, recreation and institutional facilities, businesses for sale, commercially zoned vacant land, industrial and manufacturing complexes, hotels and motels, senior and assisted living facilities, automotive related property, apartments, mobile home parks, and marinas and high &amp; drys." class="padding-right-10 justTheTip" src="<?=$base?>bootstrap/img/icon_question.gif" alt=""> </label>
                  </span> </li>
                <li> <span class="controls">
                  <label class="radio">
                  <input type="radio" name="Property_Type" value="93" data-template="land" data-action="change-property-type" onClick="propertyType('Vacant-Land');">
                  Land<img title="Includes residential, commercial, industrial, and potential development properties." class="padding-right-10 justTheTip" src="<?=$base?>bootstrap/img/icon_question.gif" alt=""> </label>
                  </span> </li>
                <li class="last-child"> <span class="controls">
                  <label class="radio">
                  <input type="radio" name="Property_Type" data-template="income" value="95" data-action="change-property-type" onClick="propertyType('Income');">
                  Income<img title="Includes multi-family dwellings such as single family homes with income potential, townhomes, duplexes, triplexes and those with four + units." class="padding-right-10 justTheTip" src="<?=$base?>bootstrap/img/icon_question.gif" alt=""> </label>
                  </span> </li>
				<li id="loader" class="loader">
					<img src="<?=$base?>img/loader.gif" />
				</li>
              </ul>
            </div>
           <form class="standardForm" method="post" action="#" id="AdvancedSearchForm">
				<input name="formType" id="form-type" type="hidden" value="Residential" />
                <div class="clearfix" id="advanced-search-form-wrapper">
						...
						<div id="dynamic-content">
                            ...
                            <div class="section">
                              ...
                              <div class="field fieldLeft">
                                ...
                                <select name="SubTypeDesc[]" title="Select Property Type" multiple class="selectField selectField-multiple" id="as_type">
                              ...
                              <div class="field fieldRight">
                                <label for="as_heatedSqft" class="bold block">Heated Square Feet</label>
                              ...
                              <div class="field fieldLeft">
                                ...
                                <select name="MinBeds" title="Select Minimum Bedrooms" class="selectField selectField-fourth" id="as_minBeds">
                                  ...
                                  <option value="property_type">1</option>
                            ...
                            <div class="section">
                              ...
                              <div id="locationFields">
                                <div id="cityField" class="field clearfix active">
                                  ...
                                  <input type="text" value="" title="Enter " name="CityLI" id="as_city" data-src="2013_residential_city" class="textField textField-full autoCompleteField validate-entry ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true">
                                </div>
                            ...
                            <div class="section noborder clearfix">
                              <h3>Water</h3>
                              <div class="field fieldLeft">
                                <label class="block bold">Water Access</label>
                                <select name="WaterAccess" class="selectField selectField-half" title="Select Water Access Preference">
                              ...
                              <div class="field fieldLeft">
                                <label class="block bold">Water Frontage</label>
                                <select name="WaterfrontProperty" class="selectField selectField-half" title="Select Water Access Preference">
                                  <option value="">No Preference</option>
                                  <option value="Yes">Yes</option>
                                  <option value="No">No</option>
                                </select>
                            ...
                            <div id="additionalDetails" class="expand-section">
                              ...
                              <div class="expand-block">
                                <div class="section">
                                  ...
                                  <div class="clearAll">&nbsp;</div>
                                  <div class="field fieldLeft">
                                    <label for="as_CondoLevel" class="bold block">Condo Floor Number</label>
                                    <input type="text" value="" title="Select Minimum Condo Unit Level" name="CondoUnitLevelMin" id="as_CondoLevel" class="textField textField-half">
                                  </div>
                                  <div class="field fieldRight msw_container">
                                  ...
                                  <div class="field fieldRight">
                                    ...
                                    <select name="feeCondoMaintenanceFrequency" title="Select Condo Maintenance Fee Schedule" class="selectField selectField-half" id="as_FeeSchedule">
                                      <option selected="selected" value="">Any</option>
                                  ...
                                  <div class="field fieldLeft">
                                    ...
                                    <select name="HOA_Frequency" title="Select HOA Payment Schedule" class="selectField selectField-half" id="as_hoaSchedule">
                                      <option selected="selected" value="">Any</option>
                                  ...
                                  <div class="field fieldRight">
                                    ...
                                    <select name="HOA_Mandatory" title="Select HOA / Community Association" class="selectField selectField-half" id="as_comAssociation">
                                      <option selected="selected" value="">Any</option>
                                ...
                                <div class="section noborder">
                                  ...
                                  <div class="field fieldLeft msw_container">
                                    ...
                                    <select class="selectField selectField-half selectField-multiple" multiple="multiple" name="GreenCertDesc[]" title="Select Multiple Green Certification Options">
                                      
                                      <option value="energy star home">Energy Star Home</option>
                                      <option value="fgbc green certified home">Fgbc Green Certified Home</option>
                                      <option value="green features call">Green Features Call</option>
                                      <option value="other - specify in remarks">Other</option>
                                    </select>
                                  </div>
                                  <div class="field fieldRight msw_container">
                            ...
                            <div id="filters" class="expand-section">
                              <div class="expand-trigger" onClick="expandBlock('filters');"> <span class="expand-icon">&nbsp;</span>
                                <h2>Search Filters</h2>
                                <p class="expand-description">Refine results by selecting open houses, luxury listings, listings with virtual tours or videos and more...</p>
                              </div>
                              <div class="expand-block">
                                <div class="section">
                                  <input type="hidden" value="" name="open_house" id="openHouseOn">
                                  <label class="block bold bottomPad">Open Houses</label>
                                  <ul class="common-filters-list clearfix" id="openHouseDatesList">
                                    <li>
                                      <label title="Do Not Show Open Houses" class="checkBoxLabel">
                                      <input type="radio" value="" name="from" title="Do Not Show Open Houses" class="noOpenHouses" checked="checked">
                                      <span>None</span> </label>
                                    </li>
                                    <li>
                                      <label title="Show Open Houses on Sat, Nov  9" class="checkBoxLabel">
                                      <input type="radio" value="2013-11-09|2013-11-09" title="Show Open Houses on Sat, Nov  9" name="from">
                                      <span>Sat, Nov  9</span> </label>
                                    </li>
                                    <li>
                                      <label title="Show Open Houses on Sun, Nov 10" class="checkBoxLabel">
                                      <input type="radio" value="2013-11-10|2013-11-10" name="from" title="Show Open Houses on Sun, Nov 10">
                                      <span>Sun, Nov 10</span> </label>
                                    </li>
                                    <li>
                                      <label title="Show Open Houses for this weekend" class="checkBoxLabel">
                                      <input type="radio" value="2013-11-09|2013-11-10" name="from" title="Show Open Houses for this weekend">
                                      <span>This Weekend</span> </label>
                                    </li>
                                    <li>
                                      <label title="Show Open Houses for this weekend" class="checkBoxLabel">
                                      <input type="radio" value="2013-11-08|2013-11-10" name="from" title="Show Open Houses for this week">
                                      <span>This Week</span> </label>
                                    </li>
                                    <li class="last-child">
                                      <label class="checkBoxLabel">
                                      <input type="radio" value="" title="All Dates" name="from">
                                      <span>All Dates</span> </label>
                                    </li>
                                  </ul>
                                </div>
                                <div class="section">
                                  <div class="field fieldLeft floatRight fieldFix">
                                    <label for="as_MinDOM" class="block bold">Days On Market</label>
                                    <select name="MaxDOM" title="Select Maximum Days On Market" class="selectField selectField-half tipByTitle" id="as_MinDOM">
                                      <option selected="selected" value="">Any</option>
                                      <option value="10">10</option>
                                  ...
                                  <div class="field fieldRight">
                                    <label for="as_Reduced_Date" class="block bold">Newly Reduced</label>
                                    <select name="Reduced_Date" title="Select Price Deduced Date" class="selectField selectField-half tipByTitle" id="as_Reduced_Date">
                                  ...
                                  <div class="clearAll">&nbsp;</div>
                                  <div class="field fieldLeft">
                                    <label class="bold block bottomPad">Special Properties</label>
                                    <label class="checkBoxLabel">
                                    <input type="checkbox" title="Select New Construction Properties" name="Custom3[]" value="new_construction_bit">
                                    <span>New Construction</span> </label>
                                    <label class="checkBoxLabel">
                                    <input type="checkbox" title="REO/ Bank Owned Properties" name="Custom3[]" value="bank_owned_bit">
                                    <span>REO/Bank Owned</span> </label>
                                    <label class="checkBoxLabel">
                                    <input type="checkbox" title="Short Sale Properties" name="Custom3[]" value="short_sale_bit">
                                    <span>Short Sale</span> </label>
                                    <label class="checkBoxLabel">
                                    <input type="checkbox" title="Properties With No Special Status" name="Custom3[]" value="NoSpecialStatus">
                                    <span>None</span> </label>
                                  </div>
                                  <div class="clearAll">&nbsp;</div>
                                </div>
                                <div class="section">
                                  <div class="field radioGroup fullwidth">
                                    <label class="bold block">Only Show Listings With</label>
                                    <label class="checkBoxLabel">
                                    <input type="checkbox" title="Select only Properties with Photos" name="PhotoCount" value="property_type">
                                    <span>Photos</span> </label>
                                    <label class="checkBoxLabel">
                                    <input type="checkbox" title="Select Properties with Virtual Tours" name="Virtual_Tour" value="property_type">
                                    <span>Virtual Tours</span> </label>
                                    <label class="checkBoxLabel">
                                    <input type="checkbox" title="Select Properties with Video Tours" name="WithVideo" value="property_type">
                                    <span>Video Tours</span> </label>
                                    <label class="checkBoxLabel last">
                                    <input type="checkbox" title="Select Properties with Virtual Tours" name="PropertyWebsiteOrIPW" value="property_type">
                                    <span>Individual Property Websites</span> </label>
                                  </div>
                                </div>
                              </div>
                            </div>
                  ...
                  <input type="submit" style="width:79px;float:right;margin-right:85px;" class="btn-search" value="">
                </div>
           </form>
        </div>
       	 <div class="clearAll">&nbsp;</div>
	...
	<div id="properties_results" style="display:none"></div>
    <div class="clearAll">&nbsp;</div>
...
<script type="text/javascript">
	$(document).ready(function(data){
		...
		$("#SimpleSearchForm").submit(function(e) {
			...
			$.ajax({
				type: 'POST',
				url: '<?=$base?>search/simple_search/15/'+offset,
				...
				success: function(result) {
					...
					else // Form Validation passed.
					{
					   ...
					   window.location.hash = '#properties_results';
					}
		...
		$("#AdvancedSearchForm").submit(function(e) {
			...
			$.ajax({
				type: 'POST',
				url: '<?=$base?>search/advance_search/15/'+offset,
	...
	function get_count(){
		$.ajax({
			type: 'POST',
			url: '<?=$base?>search/get_results_count',
			data: $( "#AdvancedSearchForm" ).serialize(),
			dataType: 'json',
			beforeSend: function(){
				//loader here
	...
	function propertyType(type){
		$('#loader').show();
		$.post('<?=$base?>search/changeType/'+type,function(data){
			$('#dynamic-wrapper').html(data);
			$('#form-type').val(type);
			$('#loader').hide();
			init();
			get_count();
	...
	function init(){
		...
		$("#countyOptions").multiselect({
			minWidth: 575,
			click: function(event, ui){
				if($('#ui-multiselect-countyOptions-option-0').is(':checked')){
					$("#countyOptions").multiselect("uncheckAll");
					$("#countyOptions").multiselect("refresh");
					$('#ui-multiselect-countyOptions-option-0').attr('checked','checked');
				}
			},
			checkAll: function(e){
				$('#ui-multiselect-countyOptions-option-0').removeAttr('checked');
			}
		});
	}
	
	function expandBlock(type){
		if(!$('#'+type).find('.expand-trigger').hasClass('expanded-true')){
			$('.expanded-true').removeClass('expanded-true');
			$('.expand-block').hide();
		}
		
		$('#'+type).find('.expand-block').toggle();
		$('#'+type).find('.expand-trigger').toggleClass('expanded-true');
	}
	
	function submit_advance_search_(){
		$.blockUI({
            css: { margin: '10px' }
		});
		$.post('<?$base?>search/advance_search',$( "#AdvancedSearchForm" ).serialize(), function(data){
			$.unblockUI();
		});
	}
	
	function submit_simple_search_(){
		$.blockUI({
            css: { margin: '10px' }
		});
		$.post('<?$base?>search/simple_search',$( "#SimpleSearchForm" ).serialize(), function(data){
			$.unblockUI();
		});
	}
...
$(window).load(function() {
	menuPosition= 345;//$('#fl_menu').position().top;
	FloatMenu();
});
...
function Parent_FloatMenu(){
	...
	if(newPosition < 345 || newPosition > 1994){
		return false;
	}
