	...
	<div class="page_layout clearfix">
		<div class="page_header clearfix">
			<div class="page_header_left">
				...
				{
					if(is_day())
						$archive_header = __("Daily archives: ", $themename) . get_the_date(); 
					else if(is_month())
						$archive_header = __("Monthly archives: ", $themename) . get_the_date('F, Y');
					else if(is_year())
						$archive_header = __("Yearly archives: ", $themename) . get_the_date('Y');
					else
