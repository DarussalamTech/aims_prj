...
<?php //} ?>
<p class="credit"><?php timer_stop(1); ?> <cite><?php printf(__('Powered by <a href="%s" title="Powered by Aims, state-of-the-art semantic personal publishing platform"><strong>Aims</strong></a>'), 'http://dtechsystems.co.uk'); ?></cite></p>
