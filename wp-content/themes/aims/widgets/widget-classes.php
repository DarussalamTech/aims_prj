			...
			while(have_posts()): the_post();
					...
					<div class="clearfix">
						<div class="item_content clearfix">';
							if(has_post_thumbnail())
								$output .= '<a class="thumb_image" href="' . get_permalink($classes_page) . '#' . urldecode($post->post_name) . '" title="' . get_the_title() . '">
				...
				$output .= '<div class="text">
						...
						<div class="item_footer clearfix">
							<a class="more icon_small_arrow margin_right_white" href="' . get_permalink($classes_page) . '#' . urldecode($post->post_name) . '" title="' . __("Details", $themename) . '">' . __("Details", $themename) . '</a>
							<a class="more icon_small_arrow margin_right_white" href="' . get_permalink($timetable_page) . '#' . urldecode($post->post_name) . '" title="' . __("Timetable", $themename) . '">' . __("Timetable", $themename) . '</a>
						</div>
					</div>
				</li>';
			endwhile;
