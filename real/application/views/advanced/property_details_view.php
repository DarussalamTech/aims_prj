...
<h1 class="page_title" style="color:#0A57A3;">Property Details</h1>
<img style="float:center; margin-left:425px; margin-bottom:20px" src="<?php echo base_url(); ?>bootstrap/img/page_title.png"></a>
...
<!--            <li><a href="#" class='nearby' id="#tab4">Nearby Properties</a></li>-->
        ...
        <div class="tabDetails">
          <div id="tab1" class="tabContents" style="display:none;">
                ...
                <table id="mainData">
                  <tbody>
                   ...
                   <?php if(!empty($property_details["county"])){  ?>
                    ...
                    <tr>
                      ...
                      <td><?php echo $property_details["num_fbaths"]; ?></td>
                    </tr>
                    <?php } ?>
                  ...
                  <?php if(!empty($property_details["ml_num"])){  ?>
                    <tr>
                      ...
                      <td><?php echo $property_details["ml_num"]; ?></td>
                    </tr>
                    <?php } ?>
                  ...
                  <tbody>
                    ...
                    <?php if(!empty($property_details["year_built"])){  ?>
                        <tr>
                          ...
                          <td><?php echo number_format($property_details["year_built"]);  ?></td>
                        </tr>
                    <?php } ?> 
                    <?php if(!empty($property_details["ml_num"])){  ?>
                    <tr>
                      <td class="label">MLS ID</td>
                      <td><?php echo $property_details["ml_num"]; ?></td>
                    </tr>
                    <?php } ?>
                    ...
                    <tr>
                      ...
                      <td><?php echo $property_details["lot_size_acres"]; ?> </td>
                    </tr>
                    <?php } ?>
                    
                     <?php if(!empty($property_details["water_frontage"])){  ?>
                    <tr>
                      <td class="label">Water Front</td>
                      <td><?php echo ($property_details["water_frontage"]==1) ? "Yes":"No"; ?>?></td>
                    </tr>
                    <?php } ?>
            ...
            <div style="padding-left:1%;display:none;margin-bottom:15px;" class="additional_toggle">
				...
				<?php
                    if(!empty($property_details["list_price"])){
				?>
                      <div class="sub-details">Price: <strong>
                <?php
				        if($property_details["list_price"] < 10){
                            echo '$' . number_format($property_details["list_price"], 0, ".", ",").',000,000';
                        }elseif($property_details["list_price"] > 10 && $property_details["list_price"] < 1000){
				...
				<?php
                        ...
                        echo '<div class="sub-details">Price: <strong>Contact realtor</strong></div>';
                    }
                ?>
                
                <?php if(!empty($property_details["property_type"])){  ?>
                <div class="sub-details">Property Type: <strong><?php echo $property_details["property_type"]; ?></strong></div>
                <?php } ?>

                <?php if(!empty($property_details["sqft_liv_area"])){  ?>
                <div class="sub-details">Sq Ft.: <strong><?php echo number_format($property_details["sqft_liv_area"], 0, ".", ",");  ?></strong></div>
                <?php } ?>
                
                <?php if(!empty($property_details["num_beds"])){  ?>
                <div class="sub-details">Bedrooms: <strong><?php echo $property_details["num_beds"]; ?></strong></div>
                <?php } ?>

                <?php if(!empty($property_details["num_fbaths"])){  ?>
                <div class="sub-details">Bathrooms: <strong><?php echo $property_details["num_fbaths"]; ?></strong></div>
                <?php } ?>
                
                <?php if(!empty($property_details["num_garage_spaces"])){  ?>
                <div class="sub-details">Parking: <strong><?php echo $property_details["num_garage_spaces"]; ?> car garage</strong></div>
                <?php } ?>
                
                <?php if(!empty($property_details["flood_zone_code"])){  ?>
                <div class="sub-details">Flood Zone: <strong><?php echo $property_details["flood_zone_code"]; ?></strong></div>
                <?php } ?>  
                ...
                <?php if(!empty($property_details["ml_num"])){  ?>
                <div class="sub-details">MLS ID: <strong><?php echo $property_details["ml_num"]; ?></strong></div>
                <?php } ?>
                
                <?php if(!empty($property_details["county"])){  ?>
                <div class="sub-details">County: <strong><?php echo $property_details["county"]; ?></strong></div>
                <?php } ?>                
                
                <?php if(!empty($property_details["lot_size_acres"])){  ?>
                <div class="sub-details">Lot Size: <strong><?php echo $property_details["lot_size_acres"]; ?></strong></div>
                <?php } ?> 
                ...
                <div class="sub-big-details" style="margin-top:15px;">Subdivision Information: <strong><?php echo $property_details["subdivision_information"]; ?></strong></div>
                <?php } ?>
                
                <?php if(!empty($property_details["subdivision_number"])){  ?>
                <div class="sub-details">Subdivision Number: <strong><?php echo $property_details["subdivision_number"]; ?></strong></div>
                <?php } ?>
                ...
                <br /><br />
                <?php if(isset($property_details["pets_allowed"])){  ?>
                <div class="sub-details">Pets Allowed: <strong><?php echo ($property_details["pets_allowed"]==1) ? "Yes":"No"; ?></strong></div>
                <?php } ?>
                
                <?php if(!empty($property_details["property_type"]) && strpos($property_details["property_type"],'Condo') !== false && !empty($property_details["hoa_common_assn"])  ){  ?>
                <div class="sub-details">HOA/Community Assn: <strong><?php echo $property_details["hoa_common_assn"]; ?></strong></div>
                <?php } ?>
                
                <?php if(!empty($property_details["property_type"]) && strpos($property_details["property_type"],'Condo') !== false && !empty($property_details["hoa_fee"]) ){  ?>
                <div class="sub-details">HOA fee: <strong><?php echo $property_details["hoa_fee"];  ?></strong></div>
                <?php } ?>
    
                <?php if(!empty($property_details["property_type"]) && strpos($property_details["property_type"],'Condo') !== false && !empty($property_details["hoa_payment_schedule"])){  ?>
           ...
           <!-- community features starts 
            ...
            <?php // } ?> -->
                ...
                <div style="padding-left:1%;display:none;margin-bottom:15px;" class="additional_toggle">
                    ...
                    <?php if(isset($property_details["waterview_yn"])){  ?>
                    <div class="sub-details">Water View: <strong><?php echo ($property_details["waterview_yn"] == 1) ? "Yes":"No"; ?></strong></div>
                    <?php } ?>
                    ...
                    <?php if(isset($property_details["water_frontage_yn"])){  ?>
                    <div class="sub-details">Water Frontage: <strong><?php echo ($property_details["water_frontage_yn"] == 1) ? "Yes":"No"; ?></strong></div>
                    <?php } ?>   
            ...
            <div style="padding-left:1%;display:none;height: 270px; overflow: auto;margin-bottom: 20px;" class="schools_toggle">
              <table>
                <tr>
                  <?php 
                                    $s=1;
                  ...
                  <td><h4>
                    ...
                    <p>Distance:
                      <?= $school->distance; ?>
                      miles &middot; <a class="more-info" target="_blank" href="<?= $school->overviewLink; ?>" style="text-decoration:underline;">more info</a></p></td>
                  <?php
                                        if($s % 2 == 0){
                                           echo '</tr><tr style="border-top:1px solid #ccc">';	
                                        }
                                       $s++;
                                    endforeach; 
                                ?>
            ...
            <div style="padding-left:1%;display:none;margin-bottom:15px;" class="interior_toggle">
                ...
                <div class="sub-details">Cooling Type:
                				<strong><?php  
									$airConditioning = explode(',',$property_details["air_conditioning"]); 
									$airConditioning = implode(', ',$airConditioning);
									echo $airConditioning;
								 ?></strong></div>
                <?php } ?>

  				<?php if(isset($property_details["fireplace_y_n"])){  ?>
                    <div class="sub-details">Fireplace: <strong><?php echo ($property_details["fireplace_y_n"] == 1) ? "Yes":"No"; ?></strong></div>
                 <?php } ?>  
                    
                 <?php if(isset($property_details["heating_description"])){  ?>
                    <div class="sub-details">Heating Type: 
                    			<strong><?php 
									$heatingDescription = explode(',',$property_details["heating_description"]); 
									$heatingDescription = implode(', ',$heatingDescription);
									echo $heatingDescription;
								?></strong></div>
                 <?php } ?>  
                
				<?php if(!empty($property_details["floor_description"])){  ?>
                <div class="sub-details">Floor: <strong><?php 
								$floorDescription = explode(',',$property_details["floor_description"]); 
                                $floorDescription = implode(', ',$floorDescription);
                                echo $floorDescription;  ?></strong></div>
                <?php } ?>
          ...
          <!-- Interior FeaturesUtilities starts -->
           <?php if(!empty($property_details["interior_features"])){  ?>
            <div style="padding-left:1%;display:none;margin-bottom:15px;" class="interior_toggle">
                <div class="sub-big-details">
                    Interior Features: 
                    <strong>
                            <?php 
                                $nteriorFeatures = explode(',',$property_details["interior_features"]); 
                                $nteriorFeatures = implode(', ',$nteriorFeatures);
                                echo $nteriorFeatures;
                            ?>
                     </strong>
               </div>
               <div class="clear"></div>
            ...
            <div style="padding-left:1%;display:none;margin-bottom:15px;" class="exterior_toggle">
                ...
                <?php if(!empty($property_details["exterior_construction"])){  ?>
                <div class="sub-details">Exterior Construction: 
                				<strong><?php  
									$exteriorConstruction = explode(',',$property_details["exterior_construction"]); 
									$exteriorConstruction = implode(', ',$exteriorConstruction);
									echo $exteriorConstruction;
								 ?></strong></div>
                <?php } ?>
                
                 <?php if(!empty($property_details["roof"])){  ?>
                <div class="sub-details">Roof:
                				 <strong><?php  
									$Roof = explode(',',$property_details["roof"]); 
									$Roof = implode(', ',$Roof);
									echo $Roof;
								 ?></strong>
                </div>
                ...
                <?php if(!empty($property_details["foundation"])){  ?>
                <div class="sub-details">Foundation: 
                				 <strong><?php  
									$Foundation = explode(',',$property_details["foundation"]); 
                ...
                <div class="sub-details">Pool: <strong><?php  
									$poolDescription = explode(',',$property_details["pool_description"]); 
									$poolDescription = implode(', ',$poolDescription);
									echo $poolDescription;
								 ?></strong></div>
                <?php } ?>   
                <div class="clear"></div>
                        
                <?php if(!empty($property_details["exterior_features"])){  ?>
           		 <div class="sub-big-details" style="margin-top:7px;">
                    Exterior Features:
                    <strong>
                            <?php 
                                $exterior_features = explode(',',$property_details["exterior_features"]); 
                                $exterior_features = implode(', ',$exterior_features);
                                echo $exterior_features;
                            ?>
                    </strong>
               	  </div>
               	<div class="clear"></div>
