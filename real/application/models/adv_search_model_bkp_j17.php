...
//                exit();
		...
		$this->db->select(" rets_properties.`sysid`, rets_properties.`1`,rets_properties.`32`,rets_properties.`46`,rets_properties.`49`,rets_properties.`175`,rets_properties.`176`,rets_properties.`178`,rets_properties.`2294`,
				   ...
				   rets_properties.`2302`,rets_properties.`2304`,rets_properties.`2368`,rets_properties.`2622`, rets_properties.`distance`,");
		...
		$this->db->where("(rets_properties.`46` LIKE '$location' OR rets_properties.`49` LIKE '$location' OR rets_properties.`175` LIKE '$location' OR rets_properties.`2302` LIKE '$location' OR rets_properties.`2304` LIKE '$location')");
                //$this->db->where("(rets_properties.`46` LIKE '$location' OR rets_properties.`49` LIKE '$location' OR rets_properties.`175` LIKE '$location' OR rets_properties.`2302` LIKE '$location' OR rets_properties.`2304` LIKE '$location' OR rets_properties.`membership_id` = 20)");
  ...
  /**
	* cron jobs model function

	*/  


function get_data_from_link($get_count = 0,$limit=15,$offset=0){
...
//$location= (($this->input->post('AddressAndLoc')) != '') ? $this->input->post('AddressAndLoc') : ''; 
$url = 'http://idx.savvycard.com/index.php/v1/Properties.json?apiKey=16e40183a6bf51c2cc1ec233db091c8b7a4d147d&function=getdata&membership_id=20&category=for_sale&property_type=&location=Miami&lat=0&lng=0&radius=20&get_count='. $get_count.'&limit='.$limit.'&offset='.$offset.'';
